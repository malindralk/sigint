...
export const COMPANIES = [
  // EM-SCA Tier 1
  {
    ...
    revenue: 68600,
    hq: 'Bethesda, USA',
    focus: 'Airborne & space SIGINT/EW',
  },
  {
    name: 'Raytheon (RTX)',
    tier: 1,
  ...
  { name: 'Secure-IC', tier: 2, sector: 'em-sca', revenue: 10, hq: 'France', focus: 'Security IP & testing' },
  {
    ...
    revenue: 5,
    hq: 'Santa Clara, USA',
    focus: 'AI-driven SCA automation',
  },
  {
    name: 'NewAE Technology',
    tier: 2,
    sector: 'em-sca',
    revenue: 3,
    hq: 'Halifax, Canada',
    focus: 'Open-source SCA platform',
  },
  ...
  { name: 'Langer EMV', tier: 3, sector: 'em-sca', revenue: 20, hq: 'Aachen, Germany', focus: 'Near-field EM probes' },
  {
    ...
    revenue: 80,
    hq: 'Herndon, USA',
    focus: 'Commercial RF geolocation',
  },
  { name: 'Unseenlabs', tier: 3, sector: 'space-sigint', revenue: 30, hq: 'France', focus: 'Maritime RF SIGINT' },
  {
    ...
    focus: 'Multi-mission constellation',
  },
];
...
export const RESEARCH_PAPERS = [
  ...
  { year: 2023, venue: 'IEEE', title: 'Dilithium CPA NTT', attack: 'CPA', target: 'Dilithium-3', traces: 30000 },
  {
    year: 2024,
    venue: 'IEEE',
    title: 'Dilithium Horizontal EM',
    attack: 'Horizontal EM',
    target: 'Dilithium (masked)',
    traces: 500000,
  },
  { year: 2024, venue: 'IEEE', title: 'FALCON Fault Attack', attack: 'Fault', target: 'FALCON', traces: 1 },
  {
    year: 2025,
    venue: 'IEEE S&P',
    title: 'Multi-channel Spatial EM',
    attack: 'MIMO Beamforming',
  ...
  },
  {
    year: 2025,
    venue: 'CHES',
    title: 'PQC Survey 12 Targets',
    attack: 'NTT Single-Trace',
    target: 'Kyber (various)',
    traces: 1,
  },
  {
    year: 2025,
    venue: 'USENIX',
    title: 'RISC-V Scalar-Crypto EM',
    attack: 'CEMA',
    target: 'SiFive X280',
    traces: 10000,
  },
  {
    ...
    venue: 'CCS',
    title: 'EMFormer ViT',
    attack: 'DL (Transformer)',
    target: 'ATmega328P ×10',
    traces: 500,
  },
  {
    year: 2026,
    venue: 'IEEE S&P',
    title: 'CEML Contrastive Learning',
    attack: 'Self-supervised DL',
    target: 'AES-256',
    traces: 100,
  },
  {
    year: 2026,
    venue: 'IEEE S&P',
    title: 'Edge TPU Model Extraction',
    attack: 'Broad-spectrum EM',
    target: 'Edge TPU',
    traces: 5000,
  },
  {
    year: 2026,
    venue: 'USENIX',
    title: 'EM-Sight Fault Injection',
    attack: 'Precision EM Fault',
    target: 'Various',
    traces: 1,
  },
  {
    year: 2026,
    venue: 'USENIX',
    title: 'EM-Probe Microarch.',
    attack: 'Microarch. Inference',
    target: 'x86 (shielded)',
    traces: 1000,
  },
  {
    year: 2026,
    venue: 'TCHES',
    title: 'Automotive CAN EM Leak',
    attack: 'CEMA Cross-domain',
    target: 'NXP S32G / RH850',
    traces: 20000,
  },
];
...
export const LEARNING_PHASES = [
  {
    ...
    color: '#39d353',
    topics: [
      'Digital Signal Processing (Coursera/Duke)',
  ...
  {
    phase: 2,
    title: 'Hardware Security & Crypto',
    weeks: '9–12',
    hours: 18,
    courses: 2,
    color: '#58a6ff',
