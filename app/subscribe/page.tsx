...
function FeatureCell({ value }: { value: string | boolean }) {
  if (value === true)
    return (
      <span role="img" style={{ color: 'var(--color-water-fortress)', fontWeight: 700 }} aria-label="Included">
        ✓
      </span>
    );
  if (value === false)
    return (
      <span role="img" style={{ color: 'var(--color-warm-stone)' }} aria-label="Not included">
        –
      </span>
    );
  ...
  return (
    ...
    >
      ...
      <header style={{ textAlign: 'center', marginBottom: '3rem' }}>
        ...
        >
          From free signal summaries to enterprise-grade multilateral data. Sovereign intelligence, precisely
          calibrated.
        </p>
      </header>
      ...
      >
        {PLANS.map((plan) => (
          <article
            ...
            style={{
              border: plan.highlight ? `2px solid ${plan.color}` : '1px solid var(--theme-border)',
            ...
            <tbody>
              {FEATURES.map((f, i) => (
                ...
                >
                  ...
                  {(['free', 'signal', 'sovereign', 'enterprise'] as PlanId[]).map((pid) => (
                    <td key={pid} style={{ textAlign: 'center', padding: '0.625rem 0.5rem' }}>
      ...
      {/* FAQ section */}
      <section aria-labelledby="faq-heading" style={{ marginTop: '3rem', maxWidth: '640px', margin: '3rem auto 0' }}>
        <h2
          id="faq-heading"
          style={{
            fontSize: '1.25rem',
